...
// Function to build and render one article
function renderArticle(article) {
  const articleDiv = document.createElement('div');
  articleDiv.classList.add('review');
  ...
  reviewsContainer.appendChild(articleDiv);
}

// Loop through articles and render them all
